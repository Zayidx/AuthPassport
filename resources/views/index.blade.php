            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 g-4">
                <div class="col">
                    <div class="book-card h-100 d-flex flex-column">
                        <div class="book-image bg-gradient-1 h-auto w-auto">
                            <img src="{{ asset('assets/img/capybara.png') }}" alt="Sampul Langit Pengetahuan" class="book-thumbnail" loading="lazy" decoding="async" width="auto" height="500">
                        </div>
            ...
            <div class="row row-cols-1 row-cols-md-2 g-4">
                    ...
                    <div class="event-card p-4 h-100">
                        <div class="d-flex gap-3">
                            <div class="event-date rounded-3 text-center px-3 py-2">
                                <div class="fw-bold fs-4 text-white">15</div>
                                <div class="small text-white">Nov</div>
                            </div>
                            <div>
                ...
                <div class="col">
                    <div class="event-card p-4 h-100">
                        <div class="d-flex gap-3">
                            <div class="event-date rounded-3 text-center px-3 py-2">
                                <div class="fw-bold fs-4 text-white">22</div>
                                <div class="small text-white">Nov</div>
                            </div>
                            <div>
                ...
                <div class="col">
                    <div class="event-card p-4 h-100">
                        <div class="d-flex gap-3">
                            <div class="event-date rounded-3 text-center px-3 py-2">
                                <div class="text-white fw-bold fs-4">29</div>
                                <div class=" text-white small">Nov</div>
                            </div>
                            <div>
                ...
                <div class="col">
                    <div class="event-card p-4 h-100">
                        <div class="d-flex gap-3">
                            <div class="event-date rounded-3 text-center px-3 py-2">
                                <div class="text-white fw-bold fs-4">05</div>
                                <div class="text-white small">Des</div>
                            </div>
                            <div>
